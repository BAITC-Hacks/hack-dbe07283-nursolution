...
**66 исходных профилей · CSV / PostgreSQL · OpenAI · Docker · Автоматические проверки**
...
- CI: тесты Python, PostgreSQL, браузерных сценариев и сборка Docker.
...
PostgreSQL, 14 браузерных сценариев — интерфейс в обоих режимах. Команды запуска и CI
...
| CI | GitHub Actions: Python 3.10 / 3.12, PostgreSQL, браузер и Docker |
...
| [Проверки и CI](docs/testing.md) | Тесты Python, PostgreSQL, браузера и GitHub Actions |
